...
const Header = ({
  className = '',
    ...
    <header className={`${className} header`}>
      <Link to="/" className="link"><img class="header__logo" alt="header logo" src={GitHubSearchLogo}></img></Link>
    {/* <a href="/" class="link">
      <img class="header__logo" alt="header logo" src={GitHubSearchLogo} />
    </a> */}
    <div class="header__item header__control">
        <NavLink to="/search" className="link link_tdn header__link">Search</NavLink>
      {/* <a class="link link_tdn header__link header__link_active" href="/search">Search</a> */}
        <NavLink to="/my-list" className="link link_tdn header__link">My list</NavLink>
